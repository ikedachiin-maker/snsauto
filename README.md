...
**❌ やってはいけない例:**
```bash
cd ~/project-A && git clone https://github.com/taiyousan15/taisun_agent.git
cd ~/project-B && git clone https://github.com/taiyousan15/taisun_agent.git  # ← 不要！
cd ~/project-C && git clone https://github.com/taiyousan15/taisun_agent.git  # ← 不要！
```
...
| やりたいこと | コマンド |
|-------------|---------|
| **新規インストール** | `git clone https://github.com/taiyousan15/taisun_agent.git && cd taisun_agent && npm install && npm run build:all && npm run perf:fast` |
