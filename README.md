...
|-------------|--------------------------|
| **インストール** | `以下のコマンドを実行して： cd ~ && git clone https://github.com/taiyousan15/taisun_agent.git && cd taisun_agent && npm install && npm run build:all` |
